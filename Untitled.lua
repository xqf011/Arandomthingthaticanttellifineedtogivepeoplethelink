...
Red = {
WindowBg      = Color3.fromRGB(28,  24,  24),
WindowBorder  = Color3.fromRGB(55,  40,  40),
TitleBg       = Color3.fromRGB(20,  16,  16),
TitleBorder   = Color3.fromRGB(50,  34,  34),
SidebarBg     = Color3.fromRGB(22,  18,  18),
SidebarBorder = Color3.fromRGB(50,  34,  34),
TabNormal     = Color3.fromRGB(22,  18,  18),
TabHover      = Color3.fromRGB(40,  28,  28),
TabActive     = Color3.fromRGB(210, 45,  45),
TabNormalText = Color3.fromRGB(140, 120, 120),
TabActiveText = Color3.fromRGB(255, 255, 255),
ContentBg     = Color3.fromRGB(31,  26,  26),
Surface       = Color3.fromRGB(42,  32,  32),
SurfaceHover  = Color3.fromRGB(55,  40,  40),
SurfaceActive = Color3.fromRGB(65,  48,  48),
Primary       = Color3.fromRGB(210, 45,  45),
PrimaryHover  = Color3.fromRGB(230, 70,  70),
PrimaryText   = Color3.fromRGB(255, 255, 255),
Border        = Color3.fromRGB(60,  44,  44),
BorderFocus   = Color3.fromRGB(210, 45,  45),
TextPrimary   = Color3.fromRGB(232, 224, 224),
TextSecondary = Color3.fromRGB(160, 130, 130),
TextMuted     = Color3.fromRGB(90,  70,  70),
Success       = Color3.fromRGB(52,  168, 83),
Warning       = Color3.fromRGB(251, 188, 4),
Error         = Color3.fromRGB(220, 53,  69),
Info          = Color3.fromRGB(66,  133, 244),
ScrollBar     = Color3.fromRGB(80,  55,  55),
ToggleOn      = Color3.fromRGB(210, 45,  45),
ToggleOff     = Color3.fromRGB(58,  42,  42),
IconTint      = Color3.fromRGB(160, 130, 130),
IconTintActive= Color3.fromRGB(255, 255, 255),
},
Blue = {
WindowBg      = Color3.fromRGB(22,  26,  34),
WindowBorder  = Color3.fromRGB(40,  50,  68),
TitleBg       = Color3.fromRGB(16,  20,  28),
TitleBorder   = Color3.fromRGB(36,  46,  62),
SidebarBg     = Color3.fromRGB(18,  22,  32),
SidebarBorder = Color3.fromRGB(36,  46,  62),
TabNormal     = Color3.fromRGB(18,  22,  32),
TabHover      = Color3.fromRGB(30,  38,  54),
TabActive     = Color3.fromRGB(50,  120, 230),
TabNormalText = Color3.fromRGB(120, 140, 170),
TabActiveText = Color3.fromRGB(255, 255, 255),
ContentBg     = Color3.fromRGB(24,  30,  40),
Surface       = Color3.fromRGB(32,  40,  56),
SurfaceHover  = Color3.fromRGB(42,  52,  70),
SurfaceActive = Color3.fromRGB(50,  62,  82),
Primary       = Color3.fromRGB(50,  120, 230),
PrimaryHover  = Color3.fromRGB(75,  145, 250),
PrimaryText   = Color3.fromRGB(255, 255, 255),
Border        = Color3.fromRGB(44,  56,  76),
BorderFocus   = Color3.fromRGB(50,  120, 230),
TextPrimary   = Color3.fromRGB(220, 228, 240),
TextSecondary = Color3.fromRGB(130, 150, 185),
TextMuted     = Color3.fromRGB(70,  88,  120),
Success       = Color3.fromRGB(52,  168, 83),
Warning       = Color3.fromRGB(251, 188, 4),
Error         = Color3.fromRGB(220, 53,  69),
Info          = Color3.fromRGB(66,  133, 244),
ScrollBar     = Color3.fromRGB(60,  78,  110),
ToggleOn      = Color3.fromRGB(50,  120, 230),
ToggleOff     = Color3.fromRGB(40,  52,  72),
IconTint      = Color3.fromRGB(130, 150, 185),
IconTintActive= Color3.fromRGB(255, 255, 255),
},
Green = {
WindowBg      = Color3.fromRGB(22,  28,  24),
WindowBorder  = Color3.fromRGB(38,  55,  42),
TitleBg       = Color3.fromRGB(16,  22,  18),
TitleBorder   = Color3.fromRGB(34,  50,  38),
SidebarBg     = Color3.fromRGB(18,  24,  20),
SidebarBorder = Color3.fromRGB(34,  50,  38),
TabNormal     = Color3.fromRGB(18,  24,  20),
TabHover      = Color3.fromRGB(28,  40,  32),
TabActive     = Color3.fromRGB(46,  185, 90),
TabNormalText = Color3.fromRGB(120, 148, 128),
TabActiveText = Color3.fromRGB(255, 255, 255),
ContentBg     = Color3.fromRGB(24,  32,  26),
Surface       = Color3.fromRGB(32,  44,  36),
SurfaceHover  = Color3.fromRGB(40,  56,  45),
SurfaceActive = Color3.fromRGB(48,  66,  54),
Primary       = Color3.fromRGB(46,  185, 90),
PrimaryHover  = Color3.fromRGB(68,  210, 112),
PrimaryText   = Color3.fromRGB(255, 255, 255),
Border        = Color3.fromRGB(42,  60,  48),
BorderFocus   = Color3.fromRGB(46,  185, 90),
TextPrimary   = Color3.fromRGB(218, 232, 220),
TextSecondary = Color3.fromRGB(128, 160, 136),
TextMuted     = Color3.fromRGB(68,  92,  74),
Success       = Color3.fromRGB(52,  168, 83),
Warning       = Color3.fromRGB(251, 188, 4),
Error         = Color3.fromRGB(220, 53,  69),
Info          = Color3.fromRGB(66,  133, 244),
ScrollBar     = Color3.fromRGB(56,  82,  64),
ToggleOn      = Color3.fromRGB(46,  185, 90),
ToggleOff     = Color3.fromRGB(38,  55,  44),
IconTint      = Color3.fromRGB(128, 160, 136),
IconTintActive= Color3.fromRGB(255, 255, 255),
},
White = {
WindowBg      = Color3.fromRGB(245, 245, 248),
WindowBorder  = Color3.fromRGB(210, 210, 218),
TitleBg       = Color3.fromRGB(235, 235, 240),
TitleBorder   = Color3.fromRGB(210, 210, 218),
SidebarBg     = Color3.fromRGB(238, 238, 244),
SidebarBorder = Color3.fromRGB(210, 210, 218),
TabNormal     = Color3.fromRGB(238, 238, 244),
TabHover      = Color3.fromRGB(225, 225, 234),
TabActive     = Color3.fromRGB(138, 75,  210),
TabNormalText = Color3.fromRGB(110, 110, 130),
TabActiveText = Color3.fromRGB(255, 255, 255),
ContentBg     = Color3.fromRGB(250, 250, 252),
Surface       = Color3.fromRGB(232, 232, 240),
SurfaceHover  = Color3.fromRGB(220, 220, 232),
SurfaceActive = Color3.fromRGB(205, 205, 220),
Primary       = Color3.fromRGB(138, 75,  210),
PrimaryHover  = Color3.fromRGB(158, 95,  230),
PrimaryText   = Color3.fromRGB(255, 255, 255),
...
Error         = Color3.fromRGB(190, 40,  55),
Info          = Color3.fromRGB(40,  100, 210),
ScrollBar     = Color3.fromRGB(190, 190, 205),
ToggleOn      = Color3.fromRGB(138, 75,  210),
ToggleOff     = Color3.fromRGB(200, 200, 215),
IconTint      = Color3.fromRGB(110, 110, 135),
IconTintActive= Color3.fromRGB(255, 255, 255),
},
}

local T = {}
for k, v in pairs(Themes.Purple) do T[k] = v end

– applyTheme: copies chosen theme into T and repaints every tracked element
...
– Smart UIScale: detects phone/tablet and scales the whole GUI down to fit
...
local scale
if isMobile then
– phones typically 360-430 wide in portrait; scale so UI fills ~90% of width
local targetW = longEdge * 0.92   – use landscape width on mobile
scale = math.clamp(targetW / 760, 0.38, 1.0)
else
– PC: just make sure it never overflows a small window
...
– Keybind: toggle window visibility (PC only, default RightShift, configurable)
...
self._currentTheme = config.Theme or “Purple”
applyTheme(self._currentTheme)

– Live-repaint window chrome when theme changes
...
-- Theme picker grid
local themeNames = {"Purple", "Red", "Blue", "Green", "White"}
local themeAccents = {
	Purple = Color3.fromRGB(138, 75,  210),
	Red    = Color3.fromRGB(210, 45,  45),
	Blue   = Color3.fromRGB(50,  120, 230),
	Green  = Color3.fromRGB(46,  185, 90),
	White  = Color3.fromRGB(138, 75,  210),
}
...
-- Make cells auto-width: 5 per row
...
local function refreshThemeBtns()
	for name, data in pairs(themeBtns) do
		...
		tw(data.card, fast, {
			BackgroundColor3 = isActive and Color3.fromRGB(themeAccents[name].R*255*0.18, themeAccents[name].G*255*0.18, themeAccents[name].B*255*0.18) or T.Surface,
		})
...
-- keep keybind label updated if it changes
_onThemeChange(function(t)
